...
lid_image = pygame.image.load("lidst.png") # Use an image with a transparent background!
outline_image = pygame.image.load("outline.png") # Use an image with a transparent background!
pupil_image = pygame.image.load("eyebb.png")  # Use an image with a transparent background!
mouth_image = pygame.image.load("mouth.png") # Use an image with a transparent background!

class RespeakerSubscriber(Node):
    
    def __init__(self):
        super().__init__('subscriber_semuscreen_eyes')
